    ...
    return (
        <group { ...props } dispose={ null } rotation={ [0, 1 * Math.PI, 0] } position={ [0, 0.1, 0] }>
            <mesh geometry={ nodes.portalCircle.geometry } position={ [0, 0.78, 1.6] } rotation={ [-Math.PI / 2, 0, 0] }>
                <portalMaterial ref={ refPortalMaterial } blending={ THREE.AdditiveBlending } uColorStart="hotpink" uColorEnd="white" />
            </mesh>
...
declare module '@react-three/fiber' {
    interface ThreeElements {
        portalMaterial: MaterialNode<THREE.ShaderMaterial, PortalMaterial>
    }
}
